...
class MouthEngine(NexusEngine):
    ...
    def __init__(self):
        ...
        # Reports are written into the artifact store in cloud mode. The
        # local report_storage_path is only used as a working dir in dev.
    ...
    async def on_startup(self):
        ...
        self.health.set_mode("report_storage", self._artifacts.backend_name)
