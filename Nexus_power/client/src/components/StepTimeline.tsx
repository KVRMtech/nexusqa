 ...
 * baseline-vs-actual two-up (VKPower's recorded known-good screenshot), plus the
        ...
        <div className="ml-1 mb-2 mt-1 rounded-lg border border-rose-200 bg-rose-50/50 p-2">
          ...
          <div className="mt-2 flex items-center gap-2 flex-wrap">
            <button onClick={analyze} disabled={diagLoading}
              title="VKPower TrueFix — diagnose the real cause of this failure ($0, on-prem)"
  ...
  return (
    <div className="mt-2 rounded-lg border border-violet-200 bg-violet-50/50 p-2.5">
      <div className="flex items-center gap-2 flex-wrap mb-1.5">
        ...
        <span className="text-[11px] font-black text-violet-900">VKPower TrueFix — root cause</span>
