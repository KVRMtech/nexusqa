...
const allNavGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      { name: 'Visual E2E Tests', href: '/visual-e2e-tests', icon: Monitor },
  ...
  return (
    <div className="flex h-full bg-[#f5f7fa]">
      ...
      <div className="flex flex-1 flex-col lg:pl-64">
        {/* Top bar */}
        <div className="sticky top-0 z-30 flex h-14 items-center justify-between gap-4 border-b border-gray-200 bg-white/95 px-4 backdrop-blur">
