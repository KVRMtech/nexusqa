// ═══════════════════════════════════════════════════════════════
//  VKPOWER AI ENGINE FACTORY — Auth Store (Zustand)
// ═══════════════════════════════════════════════════════════════
  ...
  persist(
    (set, get) => ({
      ...
      logout: () => {
        ...
        // Also clear legacy sessionStorage keys for backward compat
      ...
      hydrate: () => {
        ...
        if (state.token && state.user) {
          ...
          // Try legacy sessionStorage keys (migration from AuthContext)
          const legacyToken = sessionStorage.getItem('nexus_token');
          const legacyUser = sessionStorage.getItem('nexus_user');
