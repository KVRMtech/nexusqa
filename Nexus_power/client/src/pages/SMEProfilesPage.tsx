  ...
  return (
    <div className="group">
      <div className="flex items-center justify-between mb-1">
        ...
        <span className="text-[11px] text-slate-400">{count} rules • {confidence}% avg</span>
      </div>
        ...
        <div className="card p-4 bg-gradient-to-r from-red-500/10 to-orange-500/10 ring-red-500/20">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-8000 mt-1">
      ...
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
        <div className="stat-card">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-[#0a2540]">{profiles.length}</p>
              <p className="text-xs text-slate-400">Active SMEs</p>
            </div>
          </div>
        </div>
        <div className="stat-card">
        ...
        <div className="stat-card">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Bus Factor Risks</p>
            </div>
          </div>
        </div>
        <div className="stat-card">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Voice Enrolled</p>
            </div>
          </div>
        </div>
      </div>
        ...
        {[
          ...
          <button
            ...
            className={clsx(
              ...
              sortBy === s.key ? 'bg-nexus-500/15 text-nexus-400' : 'text-slate-400 hover:text-slate-600 hover:bg-white/[0.04]',
            )}
          >
            {s.label}
          </button>
        ...
        {sorted.map((profile) => {
          ...
          return (
            <div key={profile.speaker_id} className="card overflow-hidden">
              ...
              >
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-nexus-500 to-purple-600 text-lg font-bold text-[#0a2540] shrink-0">
                  {profile.name.charAt(0)}
                </div>

                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    <p className="text-sm font-semibold text-[#0a2540]">{profile.name}</p>
                  ...
                  <p className="text-xs text-slate-400">{profile.role} — {profile.department}</p>
                </div>

                <div className="hidden sm:flex gap-8 text-center shrink-0">
                  <div>
                    <p className="text-lg font-bold text-[#0a2540]">{profile.sessions_count}</p>
                  ...
                  <div>
                    <p className="text-lg font-bold text-[#0a2540]">{profile.expertise_areas.length}</p>
                ...
                <div className="border-t border-gray-200 animate-slide-in">
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-0 lg:divide-x lg:divide-white/[0.06]">
                    ...
                    <div className="p-5 lg:col-span-1">
                      <h4 className="text-xs font-bold uppercase tracking-wider text-slate-400 mb-3">Expertise Map</h4>
                      <div className="space-y-3">
                    ...
                    {/* Bus Factor Risks */}
                    <div className="p-5 lg:col-span-1 border-t lg:border-t-0 border-gray-200">
                          ...
                          {profile.bus_factor_risks.map((risk) => (
                            ...
                            >
                              <div className="flex items-center justify-between">
                                <span className="text-xs font-medium text-slate-700">{risk.domain}</span>
                                {risk.sole_source ? (
                    ...
                    {/* Knowledge Timeline */}
                    <div className="p-5 border-t lg:border-t-0 border-gray-200">
                      <h4 className="text-xs font-bold uppercase tracking-wider text-slate-400 mb-3">Knowledge Timeline</h4>
                      <div className="space-y-3">
                        {profile.knowledge_timeline.map((entry, idx) => (
                          <div key={idx} className="flex items-center gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                              <p className="text-xs font-medium text-slate-600 truncate">{entry.session_title}</p>
