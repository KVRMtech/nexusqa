    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-3">
        <div className="stat-card p-4">
          <p className="text-[11px] font-medium text-slate-400 uppercase tracking-wider">Total Tests</p>
          <p className="text-2xl font-bold text-[#0a2540] mt-1">{totalTests}</p>
        </div>
        <div className="stat-card p-4">
          ...
          return (
            <div key={suite.id} className="card p-4">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-xs font-medium text-slate-600">{suite.name}</span>
              </div>
              {/* Stacked bar */}
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      <h3 className="text-sm font-medium text-slate-700">{run.name}</h3>
                    </div>
                      ...
                      <div key={i} className="px-4 py-3 border-b border-white/[0.03] last:border-0 hover:bg-white/[0.02]">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs text-slate-400 mt-1 font-mono leading-relaxed">{f.error}</p>
                          </div>
                  ...
                  <tr key={suite.id} className="border-b border-white/[0.03] last:border-0 hover:bg-white/[0.02]">
                    <td className="p-3">
                      <div className="flex items-center gap-2">
                        <SuiteIcon type={suite.type} />
                        <span className="text-sm text-slate-700">{suite.name}</span>
                      </div>
                    </td>
                    <td className="p-3">
                      <span className={clsx(
                    ...
                    <td className="p-3 text-sm text-slate-600">{suite.totalTests}</td>
                    <td className="p-3">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs text-slate-8000">{pr}%</span>
                      </div>
                    </td>
                    <td className="p-3">
                      {suite.running > 0 ? (
