...
def start_all(profile: str = "canonical"):
    ...
    env["JWT_SECRET"] = "dev-e2e-test-secret-do-not-use-in-production-32chars!"
    env["NEXUS_JWT_SECRET"] = "dev-e2e-test-secret-do-not-use-in-production-32chars!"
    env["REDIS_HOST"] = "127.0.0.1"
    env["REDIS_PORT"] = "6379"
    env["REDIS_PASSWORD"] = "nexus-redis-dev"
    env["REDIS_URL"] = "redis://:nexus-redis-dev@127.0.0.1:6379/0"
    env["NEXUS_ALLOW_DEGRADED_MODE"] = "true"
    env["ORCHESTRATOR_ALLOW_IN_MEMORY_FALLBACK"] = "true"
    ...
    env["PLATFORM_API_URL"] = "http://localhost:8091"
    env["GATEWAY_MAX_REQUEST_BODY_MB"] = "500"
    env["MAX_REQUEST_BODY_MB"] = "500"
    env["LLM_BACKEND"] = "ollama"
    # Ears engine: allow Whisper model download on first run, use CPU
    env["EARS_ALLOW_REMOTE_MODEL_BOOTSTRAP"] = "true"
    env["WHISPER_DEVICE"] = "cpu"
    env["WHISPER_COMPUTE_TYPE"] = "int8"
    env["WHISPER_FAST_COMPUTE_TYPE"] = "int8"
    # Increase timeouts for first-run model downloads (EasyOCR, Whisper)
    env["EARS_TRANSCRIBER_STARTUP_TIMEOUT_SECONDS"] = "600"
    env["EARS_DIARIZER_STARTUP_TIMEOUT_SECONDS"] = "600"
    env["EYES_OCR_LOAD_TIMEOUT_SECONDS"] = "600"
