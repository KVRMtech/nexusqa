...
# tenant_id for engine/orchestrator direct calls (not used by platform API — JWT-derived)
ENGINE_TENANT_ID = "t-canonical-e2e"
    ...
    async def test_ears_idempotency_key(self):
        ...
        async with httpx.AsyncClient(timeout=30) as ac:
            ...
            r1 = await ac.post(
                ...
                data={"tenant_id": ENGINE_TENANT_ID, "session_id": str(uuid.uuid4())},
                headers=headers,
            )
