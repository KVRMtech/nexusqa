...
_STABLE_WINDOW = 5            # Consecutive stable frames before slowdown
_STABLE_INTERVAL_MULT = 5.0   # Multiply frame_interval by this during stable
