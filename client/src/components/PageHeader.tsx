...
export function PageHeader({ zone, title, subtitle, isLive, actions, children }: PageHeaderProps) {
  return (
    <div className="mb-6 space-y-4 animate-[fade-in_0.3s_ease-out]">
      {isLive === false && (
        <div
          role="alert"
        ...
        >
          ...
          <span>
            <strong>Demo Mode</strong> — The backend API is unreachable. You are
            viewing sample data. Connect to a live Nexus deployment for real
            results.
          </span>
        </div>
      )}
