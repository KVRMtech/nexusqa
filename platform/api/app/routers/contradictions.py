...
async def create_contradiction(req: CreateContradictionRequest):
    ...
    async with factory() as db:
        row = ContradictionRow(
            contradiction_id=new_id(), tenant_id=req.tenant_id,
