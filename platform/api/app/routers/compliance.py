...
async def create_jurisdiction(req: CreateJurisdictionRequest):
    ...
    async with factory() as db:
        row = JurisdictionRow(
            jurisdiction_id=new_id(), tenant_id=req.tenant_id, name=req.name,
